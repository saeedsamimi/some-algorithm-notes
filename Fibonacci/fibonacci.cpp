...
mat2D mat_power2(const mat2D &m) {
  return {m.a11 * m.a11 + m.a12 * m.a21, m.a11 * m.a12 + m.a12 * m.a22,
          m.a21 * m.a11 + m.a22 * m.a21, m.a21 * m.a12 + m.a22 * m.a22};
}

mat2D mat_prod(const mat2D &m1, const mat2D &m2) {
  return {m1.a11 * m2.a11 + m1.a12 * m2.a21, m1.a11 * m2.a12 + m1.a12 * m2.a22,
          m1.a21 * m2.a11 + m1.a22 * m2.a21, m1.a21 * m2.a12 + m1.a22 * m2.a22};
}

mat2D fib_util(int n) {
  if (n < 2) return fibonacci_mat;
...
ll fib_mat2d(int n) { return fib_util(n).a11; }
...
int main() {
  ...
  // and after that the fib_dp and after that fib_mat2d and the worst algorithm
  // is fib_rec
  ...
  for (auto func : {fib_mat2d, fib_simple, fib_dp}) fib_measure(n, func);
}